...
Future<void> main(List<String> argv) async {
  ...
  argp.addOption("search-path", abbr: "s", help: "Subdirectory Search Path");
  argp.addOption("debian-version",
  ...
  for (final jigdoFile in jigdoFiles) {
    ...
    final sha256ListContent = await http.getUrlContent(sha256ListUrl);
